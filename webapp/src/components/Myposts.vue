<template>
    <div id="bg">
        <div class="title">
            <div class="left">
                <router-link to="/myposts" class="curs">
        ...
        <div class="content">
            <template v-for="(data,index) in postlist" >
                <div class="row">
                    ...
                    <div class="intro">
                        ...
                        <p style="font-size: 16px;">{{data['created_at']}}&nbsp;&nbsp;&nbsp;<i class="fa fa-trash-o" @click="del(data.id)"></i></p>
                    </div>
                    <div class="clear"></div>
                    <div class="article">
            ...
            <div class="add">
                <router-link to="/upload">
                    <img src="static/images/add.png" alt="" width="50" height="50">
                </router-link>
            </div>
        </div>
        <!--底部固定导航-->
    ...
    export default {
        ...
        methods:{
            ...
            getPosts(){
                ...
                // 请求获取当前用户的动态数据接口
                this.axios.get('http://120.79.74.212/api/posts/'+this.userInfo.id+'/index').then((response) =>{
