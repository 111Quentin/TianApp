            ...
            <div class="panel panel-danger">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <select class="js-example-basic-multiple" name="tag_list[]" multiple="multiple" required>
                                @foreach($tags as $val)
                                    <option value="{{$val->id}}"   @if(in_array($val->id,$taglist))  selected @endif>{{$val->name}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="preview" readonly=""  required value="{{$lesson['preview']}}">
                            <img id="preview" src="{{$lesson['preview']}}" class="img-responsive img-thumbnail" width="150">
