            ...
            <div class="panel panel-danger">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="goods_sn" required>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="goods_nums" required>
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="" class="col-sm-2 control-label">市场价格</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="market_price" required placeholder="保留到小数点后两位">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="" class="col-sm-2 control-label">销售价格</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="shop_price" required placeholder="保留到小数点后两位">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="goods_thumb" readonly="" >
