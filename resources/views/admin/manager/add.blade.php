      ...
      <article class="page-container">
        <form class="form form-horizontal" id="form-admin-add">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="password" class="input-text" value="" placeholder="" id="repasswd" name="repasswd">
                </div>
            </div>
            ...
            <div class="row cl">
                    ...
                    <div class="formControls col-xs-8 col-sm-9 skin-minimal">
                        <div class="radio-box">
                            <input name="gender" type="radio" value="1" id="is_nav-1" checked>
                            <label for="is_nav-1">男</label>
                        </div>
                        <div class="radio-box">
                            <input type="radio" id="is_nav-2" value="2" name="gender">
                            <label for="is_nav-2">女</label>
                        </div>
                        <div class="radio-box">
                                <input type="radio" id="is_nav-3" value="3" name="gender">
            ...
            <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9">
                    <input type="text" class="input-text" name="avatar" readonly="" >
        ...
        $("#form-admin-add").validate({
            ...
            submitHandler: function(form) {
                $(form).ajaxSubmit({
                    ...
                    url: "/admin/manager/add",//自己提交给自己可以不写url
